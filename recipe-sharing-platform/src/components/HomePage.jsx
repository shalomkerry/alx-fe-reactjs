...
<div key={item.id} className='bg-indigo-100 flex flex-col w-[60%] hover:cursor-pointer overflow-hidden hover:shadow-[10px_20px_10px_rgba(90,90,90)] md:w-[500px] lg:w-[600px]  sm:w-[400px]  rounded-lg pb-8 mb-10 hover:scale-105 items-center justify-center '>
